...
//	}
	...
	public double withdrawFunds(double amount) throws WithdrawException {
		if (balance >= amount) {
			return balance -= amount;
...
//			return 0.0;
	...
	public void transferFunds(double amount, BankAccount account) throws WithdrawException {
